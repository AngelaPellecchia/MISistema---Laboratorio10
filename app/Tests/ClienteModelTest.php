...
class ClienteModelTest extends TestCase
{
    ...
    public function testCalcularCategoria($puntos, $categoria){
        ...
        $this->assertEquals($categoria, $mockClienteModel->calcularCategoria(1)); //Se manda cualquier dato en categoría ya que recibe como parametro puntos pero realmete no lo va a usar
    }
}
